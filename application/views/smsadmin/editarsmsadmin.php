...
if(!isset($smss[0]['idtareas'])){
  echo "Error no se encuntra el sms";
  die();
}
  ...
  <div class="header">
    <div class="header-content">
      <div class="page-title">
        <i class="icon-file-empty position-left"></i> Editar  sms - <?php echo $smss[0]['nombre']; ?>
      </div>
    </div>
  </div>
  <!-- /Page header -->
  ...
  <div class="container-fluid page-content">
    <div class="row">
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          <div class="col-lg-12">
            <form class="col-md-12" action="" id="form-criterios-sms" method="post">
              <div class="row">
                ...
                <div class="form-group col-sm-2">
                  <input type="hidden" name="tarea-tareas" id="tarea-tareas" value="<?php echo $smss[0]['idtareas']; ?>"/>
                  <input type="hidden" name="flag-tareas" id="flag-tareas" value="0"/>
                  <button type="button" class="btn btn-success" id="saveCriteriosSms">Guardar</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <div class="row">
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          <p>
            <button type="button" id="preview-sms" tarea="<?php echo $smss[0]['idtareas']; ?>" class="btn btn-warning">Vistaprevia</button>
            &nbsp;&nbsp;
            <button id="create-sms" tarea="<?php echo $smss[0]['idtareas']; ?>" class="btn btn-success">Ejecutar</button></p>
            </p>
        </div>
      </div>
    </div>
