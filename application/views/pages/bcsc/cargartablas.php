        ...
        <div class="row">
            <div class="panel panel-flat">
                <div class="panel-body">
                    ...
                    <form name ="cargartablas" id="cargartablas" method="post" enctype="multipart/form-data" action="https://<?php echo $_SERVER['HTTP_HOST']; ?>/modulo_cobranzas/index.php/uploadtablas">
