          ...
          <table class="table-bordered" style="width: 150% !important;">
            <thead>
              <tr>
                ...
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">ESP</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Nivel Riesgo</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Amortizacion</th>
                ...
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Estado Pago</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Franja</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Pago Minimo</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Pago Total</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cupo</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Vlr Utilizacion</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Ciclo</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Fecha Pago</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Vlr Cuota Max</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Vlr Cuota Fija</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuenta Patrimonio</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Grupo Afinidad</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Desc_Propietario</th>
                ...
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">A Rediferir Descuento</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Campaña</th>
              </tr>
            </thead>
            <tbody>
              ...
              ?>-->
                <tr>
                  ...
                  <td nowrap style="text-align: center;"><?php echo $cr['descripcion_esp']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['nivel_riesgo']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['amortizacion']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['fecha_desembolso']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['saldo_capital'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['dias_sistema']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['diasActual']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['estadoPago']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['franja_mora']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['pago_minimo'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['pago_total'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['cupo'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['valor_utilizacion'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['ciclo']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['fecha_limite_pago']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['valor_cuota_fija'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['valor_cuota_maxima'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['cuenta_patrimonio']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['grupo_afinidad']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['descripcion_propietario']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['porc_dcto']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['pago_dcto'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo number_format($cr['arediferir_dcto'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['camapana']; ?></td>
                </tr>
              <?php } ?>
