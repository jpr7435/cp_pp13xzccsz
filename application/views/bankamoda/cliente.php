  ...
  <div class="container-fluid page-content">
      ...
      <div class="panel panel-flat">
        <div class="panel-body" style="overflow-x: auto;">
          <table class="table-bordered" style="width: 100% !important;">
            <thead>
              <tr>
                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Operacion</th>
                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Pertenencia</th>
                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuenta Donde Pagar</th>
                ...
                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Intereses Financiamiento</th>
                ...
                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Fecha de Corte</th>
            ...
            <tbody>
              ...
              foreach ($creditos as $cr) {
                ...
                <tr <?php echo $estiloFila; ?>>
                  ...
                  <td style="text-align: center;"><?php echo $cr['pertenencia']; ?></td>
                  <td style="text-align: center;"><?php echo $cr['cuentapagos']; ?></td>
                  <td style="text-align: center;"><?php echo $cr['dias_mora_actual']; ?></td>
                  ...
                  <td style="text-align: center;"><?php echo number_format($cr['intfto'], 0);?></td>
                  <td style="text-align: center;"><?php echo number_format($cr['intmora'], 0);?></td>
                  <td style="text-align: center;"><?php echo $cr['fechavto']; ?></td>
                  <td style="text-align: center;"><?php echo $cr['Fecha_ultimo_pago']; ?></td>
                </tr>
              <?php } ?>
        ...
        <div class="panel-body">
          <div class="panel-group accordion" id="accordion-styled">
            <div class="panel">
              ...
              <div class="panel-heading">
                <div class="panel-title">
                  <a data-toggle="collapse" data-parent="#accordion-styled" href="#ratificaciones">Ratificaciones</a>
                </div>
              </div>
              <div id="ratificaciones" class="panel-collapse collapse">
                <div class="panel-body" style="overflow-x: auto;">
                  <table class="table-bordered" style="width: 100% !important;">
                    <thead>
                      <tr>
    ...
    <div class="row">
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          <button type="button" id="gestionCompleta" class="btn btn-info btn-xs">Toda</button>&nbsp;&nbsp;&nbsp;<button type="button" id="gestionEfectiva" class="btn btn-success btn-xs">Efectiva</button>&nbsp;&nbsp;&nbsp;<button type="button" id="gestionSms" class="btn btn-warning btn-xs">SMS</button></br></br>
