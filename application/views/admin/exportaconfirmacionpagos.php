...
$nombre = "ConfirmacionPagos";

$short = $nombre . $fecha . ".csv";
$filename = $this->config->item('ruta_local')."/informes/nocturno/" . $nombre . $fecha . ".csv";
...
foreach ($llamadas as $c) {
    ...
    $asesor = $ci2->vista->getusuario($c['idAsesorAsignado'], $session['proyecto_activo']);
