...
$linea .= "Documento;Fecha Gestion;Hora;Telefono;Accion; Contacto; Motivo; Resultado; Fecha Acuerdo; Valor Acuerdo; Complemento; Texto Gestion; Asesor;Tiempo" . "\n";
...
foreach ($llamadas as $c) {
    ...
    $actual = $c['documentodos'] . ";" . $c['fechaGestion']. ";" . $c['hora'] . ";" . $c['telefono'] . ";" . $acc[0]['descripcion'] . ";" . $cont[0]['descripcion'] . ";" . $mot[0]['descripcion'] . ";" . $resu[0]['descripcion'] . ";" . $c['fechaAcuerdo']  . ";" . $c['vlAcuerdo']  . ";" . $c['complemento']  . ";" . $txt  . ";" . $asesor[0]['usuario']  . ";" . $c['tiempo']  . "\n";
    str_replace(",", ".", $actual);
    $linea .= $actual;
