        ...
        <div class="row">
            <div class="panel panel-flat">
                <div class="panel-body">
                    <form name="execute-baseini" id="execute-baseini" method="post" action="https://<?php echo $_SERVER['HTTP_HOST']; ?>/modulo_cobranzas/index.php/executeactualizacion/<?php echo $session['proyecto_activo']; ?>">
                        ...
                        <table class="table table-togglable table-hover footable-loaded footable tablet breakpoint">
                            ...
                            foreach ($creditos as $cr) {
                                ...
                                if ($cr['Field'] != 'idCreditos' && $cr['Field'] != 'idevolutivo' && $cr['Field'] != 'documento' && $cr['Field'] != 'fechacargue' && $cr['Field'] != 'activo' && $cr['Field'] != 'fechaActualizacion' && $cr['Field'] != 'estadoActual') {
                                    ?>
                                    <tr>
