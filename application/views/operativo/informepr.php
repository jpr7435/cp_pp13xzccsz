    ...
    <div class="header">
        <div class="header-content">
            <div class="page-title">
                <i class="icon-file-empty position-left"></i> Productividad por fecha <?php echo $session['proyecto_activo']; ?>
            </div>
        </div>
    </div>
    <!-- /Page header -->
        ...
        <div class="col-md-12 col-sm-12">
          <div class="panel panel-info panel-border border-info">
            <div class="panel-heading">
              <h5 class="panel-title">Fecha del Informe</h5>
            </div>
            <div class="panel-body" style="text-align: left;">
              <form name="informe-pr" id="informe-pr" method="post" action="https://<?php echo $_SERVER['HTTP_HOST']; ?>/modulo_cobranzas/index.php/informeprodc/f">
                  <div class="form-group">
                      <label>Fecha:</label>
                      <input type="text" name="fechaIni" style="width: 150px; color: #000;" readonly="readonly" id="fechaIni" value="<?php echo date("m/d/Y"); ?>" class="form-control datepicker-here" data-language='en' />
                  </div>
                  <div class="form-group">
                      <button class="btn btn-success btn-labeled"  id="informePr-btn" type="submit"><b><i class="icon-floppy-disk"></i></b>Generar</button>
                  </div>
              </form>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <div class="panel-title">Productividad del dia <?php echo $hoy; ?></div>
            </div>
