  ...
  <div class="container-fluid page-content">
        ...
        <div class="panel-body">
          <div class="panel-group accordion" id="accordion-styled">
            <div class="panel">
              ...
              <div class="panel-heading">
                <div class="panel-title">
                  <a data-toggle="collapse" data-parent="#accordion-styled" href="#juridico">Juridico</a>
                </div>
              </div>
              <div id="juridico" class="panel-collapse collapse">
                <div class="panel-body" style="overflow-x: auto;">
                  <table class="table-bordered" style="width: 100% !important;">
                    <thead>
                      <tr>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Juzgado Actual</th>
                        ...
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Estado Corre Mes</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Fecha Presentacion Demanda</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Mandamiento</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Registro Medidas Cautelares</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Bienes Sujetos de Embargo</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Sentencia</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Titulos</th>
                        <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Valor Titulos</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      foreach ($juridicos as $jg) { ?>
                        <tr>
                          <td style="text-align: center; background-color: #f7dc6f;"><?php echo $jg['juzgado']; ?></td>
                          <td style="text-align: center; background-color: #f7dc6f;"><?php echo $jg['ciudadjuzgado']; ?></td>
                          <td style="text-align: center; background-color: #f7dc6f;"><?php echo $jg['radicadodemanda']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['macroetapaactual']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['fechapresentaciondemanda']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['mandamientodepago']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['registromedidascautelares']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['bienessujetosdeembargo']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['sentencia']; ?></td>
                          <td style="text-align: center;"><?php echo $jg['titulos']; ?></td>
                          <td style="text-align: center;"><?php echo  number_format($jg['valor_titulos'], 0); ?></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
    ...
    <div class="row">
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          <button type="button" id="gestionCompleta" class="btn btn-info btn-xs">Toda</button>&nbsp;&nbsp;&nbsp;
          <button type="button" id="gestionEfectiva" class="btn btn-success btn-xs">Efectiva</button>&nbsp;&nbsp;&nbsp;
          <button type="button" id="gestionJudicial" class="btn btn-danger btn-xs">Judicial</button>
        </br></br>
