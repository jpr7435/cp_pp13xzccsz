                ...
                <div class="panel panel-flat borde-azul" style="height: 300px; overflow: auto;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Cuenta Pagos Cartera Propia:</th>
                                <th>Banco:</th>
                            </tr>
                            <tr>
                                <td><?php echo "000290296" ?></td>
                                <td><?php echo "AV Villas - Cuenta Corriente Puntualmente SAS" ?></td>
                    ...
                    <table class="table-bordered" style="width: 150% !important;">
                        <thead>
                            <tr>
                                ...
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Empresa</th>
                                ...
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Total Vencido</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">1 Pago</th> 
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">2 Pagos</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">12 Meses</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Desembolso</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Int Ctes</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Int Mora</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Fch Desem.</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuota</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Dia de Pago</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Forma de Pago</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Nombre Oficina</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Zona Oficina</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Juzgado</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Etapa</th>
                                <th style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Radicado</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($creditos as $cr) { ?>
                                ...
                                <tr>   
                                    ...
                                    <td style="text-align: center;"><?php echo $cr ['empresa']; ?></td>
                                    <td style="text-align: center;"><?php echo $cr['diasmora']; ?></td>
                                    <td style="text-align: center;"><?php echo $cr['producto']; ?></td>
                                    <td style="text-align: center;"><?php echo number_format($cr['saldocapital'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo number_format($cr['saldototal'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo number_format($cr['totalvencido'], 0); ?></td>
                                    <td style="text-align: center; background-color: #F5F6CE;"><?php echo "$" . " " . number_format($cr['saldocapital'] / 2 * 1.4, 0); ?></td>
                                    <td style="text-align: center; background-color: #F5F6CE;"><?php echo "$" . " " . number_format($cr['saldocapital'] * 0.6 * 1.4, 0); ?></td>
                                    <td style="text-align: center; background-color: #F5F6CE;"><?php echo "$" . " " . number_format($cr['saldototal'] * 0.9, 0); ?></td>
                                    <td style="text-align: center;"><?php echo "$" . " " . number_format($cr['credito'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo "$" . " " . number_format($cr['interesesCorrientes'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo "$" . " " . number_format($cr['interesMora'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo $cr['fecha_desembolso']; ?></td>
                                    <td style="text-align: center;"><?php echo "$" . " " . number_format($cr['cuota'], 0); ?></td>
                                    <td style="text-align: center;"><?php echo $cr['diapago']; ?></td>
                                    <td style="text-align: center;"><?php echo $cr['formapago']; ?></td>
                                    <td style="text-align: center;"><?php echo $cr['nomoficina']; ?></td>
                                    <td style="text-align: center;"><?php echo $cr['zonaoficina']; ?></td>
                                    <td style="text-align: center;"><?php echo $cliente[0]['juzgado']; ?></td>
                                    <td style="text-align: center;"><?php echo $cliente[0]['etapaprocesal']; ?></td>
                                    <td style="text-align: center;"><?php echo $cliente[0]['radproceso']; ?></td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: bold;"></td>
                                <td style="text-align: center; font-weight: bold;"></td>
                                <td style="text-align: center; font-weight: bold; background-color: #a4a4a4;"><?php echo 0; ?></td>
                                <td style="text-align: center; font-weight: bold; background-color: #a4a4a4;"><?php echo 0; ?></td>
                                <td style="text-align: center; font-weight: bold; background-color: #a4a4a4;"><?php echo 0; ?></td>
                                <td style="text-align: center; font-weight: bold;"></td>
                                <td style="text-align: center; font-weight: bold;"></td>
