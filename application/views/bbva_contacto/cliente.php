          ...
          <table class="table-bordered" style="width: 80% !important;">
            <thead>
              <tr>
                ...
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Plazo Inicial</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Vlr_Inicial_OP</th>
                ...
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Rango_Mora</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Oficina</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Territorial</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Zona</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Plazo_Res</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuota_Inicial</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuotas_en_Corr</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Convenio</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Estado_Actual</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Segmento</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Causal_No_Descuento</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuota_Actual</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Porcentaje</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Indicador_Actual</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Guion</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Efectiva_Nueva</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Plazo_Trans</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Plazo_Requerido</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">PLazo_Total</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Alternativa</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">Cuotas_a_Corr</th>
                <th nowrap style="background-color: #819FF7; text-align: center; color: #FFF; font-weight: lighter;">T_Cuotas_Corr</th>
              </tr>
            </thead>
            <tbody>
              <?php
              foreach ($creditos as $cr) {
                ...
                <tr>
                  ...
                  <td nowrap style="text-align: center;"><?php echo $cr['plazo_inicial']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo "$". number_format($cr['vlr_inicial_op'],0); ?></td>
                  ...
                  <td nowrap style="text-align: center;"><?php echo $cr['rango_mora']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['oficina']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['territorial']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['zona']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['plazo_res']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo "$". number_format($cr['cuota_ini'], 0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['cuotas_en_corr']; ?></td>
                  ...
                  <td nowrap style="text-align: center;"><?php echo $cr['causal_no_descuento']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo "$". number_format($cr['cuota_actual'],0); ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['porcentaje']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['indicador_actual']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['guion']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['efectiva_nueva']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['plazo_trans']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['plazo_requerido']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['plazo_total']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['alternativa_norm']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['cuotas_a_corr']; ?></td>
                  <td nowrap style="text-align: center;"><?php echo $cr['t_cuotas_corr']; ?></td>
